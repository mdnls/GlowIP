...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', type=int, nargs='+', help='no. of measurements',
                        default=[12288, 10000, 7500, 5000, 2500, 1000, 750, 500, 400, 300, 200, 100, 50, 30, 20])
    ...
    parser.add_argument('-noise', type=str,
                        help='noise to add. Either random_bora or float representing std of gaussian noise',
                        default="random_bora")
    ...
    parser.add_argument('-save_results', type=bool, help='whether to save results after experiments conclude',
                        default=True)
